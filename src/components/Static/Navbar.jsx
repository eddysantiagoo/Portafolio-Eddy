        ...
        >
            ...
            >
                <div style={{ zIndex: 999 }}>
                    ...
                    <div className="mt-8 space-y-2">
                    <div className="flex items-center gap-2">
                    <p className="text-xs font-medium uppercase text-black/50 dark:text-white/10">Redes Sociales</p>
                            <div className="w-full h-0.5 bg-black/50 dark:bg-white/10" />
                        </div>
                        <div className="flex items-center gap-2">
                        ...
                        <Link href="https://www.instagram.com/santi.xoo/">
                                <a
                                    onClick={() => setIsOpen(false)} target="_blank"
                                    className="flex gap-2 px-4 items-center w-full h-12 bg-gray-500/5 rounded-lg hover:bg-gray-500/10 transition-all duration-200 text-zinc-400 hover:text-black hover:dark:text-white "
                                >
                        ...
                        <Link target="_blank" href="https://open.spotify.com/user/s4ntiag00">
                                <a
                                    onClick={() => setIsOpen(false)} target="_blank"
                                    className="flex gap-2 px-4 items-center w-full h-12 bg-gray-500/5 rounded-lg hover:bg-gray-500/10 transition-all duration-200 text-zinc-400 hover:text-black hover:dark:text-white"
                                >
